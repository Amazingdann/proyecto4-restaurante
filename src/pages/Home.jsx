    ...
    return ( 
      ...
      <div className="row m-5 text-center">
        <div className="w3-half ">
          <img src={comida1} style={{width: '200px', height: '200px'}}  alt="Concrete meets bricks" className="col-md-3 m-4" />
          <img src={comida2} style={{width: '200px', height: '200px'}} alt="Light, white and tight scandinavian design" className="col-md-3 m-4"/>
          <img src={comida3} style={{width: '200px', height: '200px'}} alt="White walls with designer chairs" className="col-md-3 m-4" />
          <img src={comida4} style={{width: '200px', height: '200px'}} alt="Windows for the atrium"  className="col-md-3 m-4"  />
          <img src={comida5} style={{width: '200px', height: '200px'}}  alt="Bedroom and office in one space" className="col-md-3 m-4" />
          <img src={comida6} style={{width: '200px', height: '200px'}}  alt="Scandinavian design" className="col-md-3 m-4" />
        </div>
